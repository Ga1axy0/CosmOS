...
fig.tight_layout()
fig.savefig(os.path.join(OUT, "fs_page_cache_iozone.png"), dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(os.path.join(OUT, "fs_block_cache.png"), dpi=150)
plt.close(fig)
...
ax.grid(axis="y", linestyle="--", alpha=0.4)
fig.tight_layout()
fig.savefig(os.path.join(OUT, "fs_inode_dentry_cache.png"), dpi=150)
plt.close(fig)
...
ax.grid(axis="y", linestyle="--", alpha=0.4)
fig.tight_layout()
fig.savefig(os.path.join(OUT, "fs_stat_cache.png"), dpi=150)
plt.close(fig)
